      ...
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 px-12 sm:px-0">
          {portfolios.map(({ id, src, img, code, title }) => (
            ...
            >
              <p className=" flex justify-center mb-2 p-1 ">{title}</p>
              <a href={src} target="_blank" rel="noreferrer">
                <img src={img} alt="" className="rounded-md duration-300 " />
              </a>
              <div className="flex items-center justify-center ">
                <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 hover:underline">
                  <a href={src} target="_blank" rel="noreferrer">
                    Demo
                  </a>
                </button>
